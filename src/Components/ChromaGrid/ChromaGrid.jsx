    ...
    >
      {data.map((c, i) => (
        <article
          ...
          onContextMenu={c.onRightClick || undefined}
          className="group relative flex flex-col w-[250px] h-[320px] rounded-[20px] overflow-hidden border-2 border-transparent transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl"
          style={{
