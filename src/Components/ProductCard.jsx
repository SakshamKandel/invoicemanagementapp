            ...
            <div className="p-2 sm:p-3 md:p-4 flex-1 flex flex-col">
                <div className="flex flex-col gap-1 mb-2">
                    <div className="flex justify-between items-start gap-1">
                        ...
                        <span className={`px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full text-xs font-medium whitespace-nowrap ${currentProduct.available
                ...
                <div className="mt-auto pt-2 sm:pt-3 border-t border-gray-200">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Button
                            ...
                            className={`w-full px-2 sm:px-3 py-1.5 sm:py-2 rounded-md font-medium transition-colors duration-200 text-xs sm:text-sm ${currentProduct.available
